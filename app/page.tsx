    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Breaking barriers to education with multilingual AI tutoring accessible via web, SMS, voice calls, and
            community stations.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h3 className="text-3xl font-bold text-center text-gray-900 mb-12">Multiple Ways to Learn</h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <CardDescription>Physical learning stations in communities for collaborative learning.</CardDescription>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 mb-2">AI-Powered Tutoring</h4>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 mb-2">Teacher Network</h4>
                <p className="text-gray-600">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 mb-2">Scholarship Alerts</h4>
                <p className="text-gray-600">
