...
import { CheckCircle, XCircle, Home, BarChart3, Clock, Trophy } from "lucide-react"
    ...
    try {
      ...
      const response = await fetch('/api/ai/generate-quiz', {
        ...
        body: JSON.stringify({
          ...
          concept,
          prompt: `Generate ${count} ${level} level questions specifically about ${subject === "general" ? concept : subject}. The questions should be directly related to ${subject === "general" ? concept : subject} concepts, terminology, and practical applications. Each question should have 4 multiple choice options and one correct answer. Return as JSON with format: [{"question": "...", "options": ["...", "...", "...", "..."], "correctAnswer": "..."}]`
        })
      })
  ...
  const generateSampleQuestions = (): Question[] => {
    ...
    if (subject === "general" && concept) {
      ...
      if (conceptSpecificQuestions) {
        ...
        return shuffled.slice(0, parseInt(count || '5'))
      }
      ...
      return genericQuestions.slice(0, parseInt(count || '5'))
    }

    // Fallback to subject questions or general questions
    const baseQuestions = subjectQuestions[subject || 'general'] || subjectQuestions.general
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Creating {count} {level} level questions about {subject === "general" ? concept : subject}</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-6">
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="mb-8">
            <CardHeader>
              <CardTitle className="text-center text-2xl">Your Performance</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                ...
                <div>
                  <div className="text-4xl font-bold text-purple-600 mb-2">{Math.round(timeSpent)}m</div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="text-right">
            ...
            <div className="text-sm text-gray-600">Time: {Math.round((Date.now() - quizStartTime) / 1000)}s</div>
          </div>
        </div>
