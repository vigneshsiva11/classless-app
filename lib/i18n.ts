...
const pa: Dict = {
  ...
  voice_calls_desc:
    'ਆਡਿਓ-ਅਧਾਰਿਤ ਸਿੱਖਣ ਅਤੇ ਸਵਾਲਾਂ ਲਈ IVR ਪ੍ਰਣਾਲੀ.',
  community_stations: 'ਕਮਿਊਨਿਟੀ ਸਟੇਸ਼ਨ',
  community_stations_desc:
    'ਸਹਿਯੋਗੀ ਸਿੱਖਿਆ ਲਈ ਸਮੂਹਕ ਸਟੇਸ਼ਨ.',
  ...
  feature_teachers_desc:
    'ਪੇਚੀਦਾ ਸਵਾਲਾਂ ਲਈ ਯੋਗ ਅਧਿਆਪਕਾਂ ਨਾਲ ਜੁੜੋ.',
...
const hi: Dict = {
  ...
  voice_calls_desc:
    'ऑडियो-आधारित सीखने और प्रश्नों के लिए IVR प्रणाली.',
  community_stations: 'सामुदायिक स्टेशन',
  community_stations_desc:
    'सहयोगी सीखने के लिए सामुदायिक स्टेशन.',
  ...
  feature_teachers_desc:
    'जटिल प्रश्नों के लिए योग्य शिक्षकों से जुड़ें.',
...
const ta: Dict = {
  ...
  voice_calls_desc:
    'குரல் அடிப்படையிலான கற்றலுக்கும் கேள்விகளுக்கும் IVR.',
